...
#kit.continuous_servo[pinTHR].throttle = 1 #Shaya
...
def move_robot(thrnum,strnum):
    ...
    #kit.continuous_servo[pinTHR].throttle = thrnum #shaya
    ...
    print(bs1)
    kit.servo[2].angle = bs1     #kit.servo[2].angle = bs1   
