...
def generate_launch_description():
    ...
    default_slam_params_path = os.path.join(pkg_share, 'config', 'localization_params.yaml')
    default_map_file_path = '/home/kingpooper/deepRacerWS/my_map.yaml'
    ...
    declare_slam_params_arg = DeclareLaunchArgument(
        name='slam_params', default_value=default_slam_params_path,
        description='Full path to the slam_toolbox parameters file to use'
    )
    ...
    slam_toolbox_node = Node(
        ...
        output='screen',
        parameters=[
            {'use_sim_time': False, 'map_file_name': '/home/kingpooper/deepRacerWS/my_map.yaml'},
